...
- Env vars:
  ...
  - `ALLOWED_ORIGINS` (include your deployed frontend origin, e.g. `https://glockstock.github.io`; for Capacitor apps include `capacitor://localhost` (iOS) and `http://localhost` (Android))
